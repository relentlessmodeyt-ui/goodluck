...
(function () {
  ...
  (function sparkle() {
    ...
    var N = window.innerWidth < 640 ? 12 : 38;
  ...
  (function shootingStars() {
    ...
    function spawn() {
      ...
      ], { duration: (big ? 3200 : 2300) + Math.random() * 800, easing: 'cubic-bezier(.25,.1,.25,1)' });
  ...
  function countUp(el) {
    ...
    /* reserve the final width so the layout doesn't shift/glitch while counting */
